...
def generate_timeseries(prices, n):
    """Use the first time period to generate all possible time series of length 
...
# prices1 + prices2 + prices3 = prices  
...
timeseries180 = generate_timeseries(prices1, n=180)
timeseries360 = generate_timeseries(prices1, n=360)
timeseries720 = generate_timeseries(prices1, n=720)
...
#data shape == (k, lengh of y of series)
centers180 = find_cluster_centers(timeseries180, k=100)
# data shape ==(n,y) y == lengh of y of series == lengh of y of centers
s1 = choose_effective_centers(centers180, n=20)

centers360 = find_cluster_centers(timeseries360, k=100)
s2 = choose_effective_centers(centers360, n=20)

centers720 = find_cluster_centers(timeseries720, k=100)
s3 = choose_effective_centers(centers720, n=20)
